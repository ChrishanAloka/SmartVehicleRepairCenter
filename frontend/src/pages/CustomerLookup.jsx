                            ...
                            <div className="d-flex align-items-center justify-content-between mb-4">
                                ...
                                <div className="d-flex gap-2">
                                    {getTodayActiveBookings().map(myBooking => {
                                        const pendingList = allTodayBookings.filter(b => b.status === 'pending');
                                        const repairingList = allTodayBookings.filter(b => b.status === 'accepted' && !b.isPaidOut);
                ...
                <Modal.Body className="p-4">
                    <Form>
                        ...
                        <Row>
                            ...
                            <Col md={6}>
                                <Form.Group className="mb-3">
                                    <Form.Label className="fw-bold small text-muted text-uppercase">Vehicle Model</Form.Label>
                                    <Form.Control
                                        type="text"
                ...
                <Modal.Body className="p-4">
                    <Form>
                        ...
                        <div className="alert alert-info py-2 small border-0">
                            <FaClock className="me-2" /> You can only edit details while your vehicle is in the Waiting List.
                        </div>
                    </Form>
                </Modal.Body>
                <Modal.Footer className="border-0 p-4 pt-0">
